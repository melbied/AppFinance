...
public class Lignecommande implements Serializable {
    ...
    @Column(name = "Desc_besoin")
    private String Desc_besoin;
    ...
    public String getDesc_besoin() {
        return Desc_besoin;
    }

    public void setDesc_besoin(String Desc_besoin) {
        this.Desc_besoin = Desc_besoin;
    }
